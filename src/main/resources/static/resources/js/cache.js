        ...
        layer.open({
            ...
            content:
                    '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;">' +
                        '<p class="layui-red">尊敬的用户:</p></pclass></p>' +
                        '<p>' +
                            '感谢您使用'+'<span class="layui-red">图书管理系统。</span>' +
                            '我们竭诚用最好的服务祝您实现轻松愉快的借阅体验。' +
                        '</p>' +
                    '</div>',
    ...
    function lockPage(){
        ...
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="/resources/images/fox.png" class="userAvatar" alt=""/></div>'+
